...
export default function VendorRegistration() {
  const VendorRegistrationInputs = [
    ...
    { id: 10, name: "MSMERegistrationNumber", label: "MSME Registration Number", type: "text", placeholder: "Enter MSME Registration Number" },
       {id:11,name:"UIDAINumber",label:"UIDAI Number",type:"text",placeholder:"Enter UIDAI Number"},
    { id: 12, name: "CINNumber", label: "CIN Number", type: "text", placeholder: "Enter CIN Number" },
    { id: 13, name: "NearestLandmark", label: "Nearest Landmark", type: "text", placeholder: "Enter Nearest Landmark" },
    { id: 14, name: "PhoneNumber", label: "Phone Number", type: "text", placeholder: "Enter Phone Number", required: true },
    { id: 15, name: "Email", label: "Email", type: "email", placeholder: "Enter Email", required: true },
    { id: 16, name: "Website", label: "Website", type: "text", placeholder: "Enter Website" },
    { id: 17, name: "NatureofBusiness", label: "Nature of Business", type: "text", placeholder: "Enter Nature of Business", required: true },
    { id: 18, name: "TypeofBusiness", label: "Type of Business", type: "text", placeholder: "Enter Type of Business", required: true },
    { id: 19, name: "ProductDetails", label: "Product Details", type: "text", placeholder: "Enter Product Details", required: true },
    { id: 20, name: "TotalTurnoverPerAnnum", label: "Turnover Per Annum", type: "text", placeholder: "Enter Turnover Per Annum" },
    { id: 21, name: "TotalEmployees", label: "Total Employees", type: "text", placeholder: "Enter Total Employees" },
    { id: 22, name: "imageUrl", label: "File Upload(5MB)", type: "file" , required: true },
  ];
